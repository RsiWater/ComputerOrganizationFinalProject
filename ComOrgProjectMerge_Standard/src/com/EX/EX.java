...
public class EX
{
   ...
   public void startEX() {
	   ...
	   {
	   		this.resetCurrentInstruction();
			exmem.resetRegEXMEM();
	   		return;
	   }

	   if(idex.getCurrentInstruction().equals("null")) this.currentInstruction = "null";
	   else this.currentInstruction = idex.getCurrentInstruction();
   ...
   public void resetCurrentInstruction() { this.currentInstruction = "null"; }
	public boolean isNull() {
		if(idex.getCurrentInstruction().equals("null")) return true;
		else return false;
	}
