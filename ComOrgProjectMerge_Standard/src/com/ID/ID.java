...
public class ID {
	...
	private int reg1, reg2, regNum1, regNum2;
	...
	public void startID() {
//		System.out.println("regNum1 = " + regNum1);
//		System.out.println("regNum2 = " + regNum2);
//		System.out.println(ifid.getInstruction_machineCode());
		if(this.exhazardflag || this.memhazardflag)
		{
			reg1 = regs[regNum1].getValue();
			reg2 = regs[regNum2].getValue();
			idex.setReg1(reg1);
			idex.setReg2(reg2);
			return;
		}

		if(ifid.getCurrentInstruction().equals("null")) this.currentInstruction = "null";
		else this.currentInstruction = ifid.getCurrentInstruction();
...
//		System.out.println(exmem.getReg()+""+checkreg1+""+checkreg2);
		...
		if((exmem.getReg() != 0 && exmem.getRegWrite() && ((checkreg1 == exmem.getReg() && checkreg1 != 0) || (checkreg2 == exmem.getReg() && checkreg2 != 0))))
		{
			exhazardflag = true;
//			System.out.println("stall");
		}
		else if((memwb.getDisReg() != 0 && memwb.getRegWrite()) && ((checkreg1 == memwb.getDisReg() && checkreg1 != 0) || (checkreg2 == memwb.getDisReg() && checkreg2 != 0)))
		{
			memhazardflag = true;
//			System.out.println("m-stall");
		}

//		if((checkreg1==exmem.getReg()||checkreg2==exmem.getReg())&&(checkreg1!=0&&checkreg2!=0&&exmem.getReg()!=0)&&exmem.getRegWrite())
//		{
//			exhazardflag=true;
//			System.out.println("stall");
//		}
...
//		}
		...
		regNum1 = (ifid.getInstruction_machineCode()&65011712)/2097152;
		regNum2 = (ifid.getInstruction_machineCode()&2031616)/65536;
		...
		if(opcode==0) {  //add sub
			if((ifid.getInstruction_machineCode()&63) == 32) {
				idex.setRegIDEX(true, 0, false, false, false, false, true, false);
				idex.setCurrentInstruction("add");
				//System.out.println("add");
			}
			else { //sub
				idex.setRegIDEX(true, 1, false, false, false, false, true, false);
				idex.setCurrentInstruction("sub");
				//System.out.println("sub");
			}
		}
		else if(opcode==-2080374784) { //lw
			idex.setRegIDEX(false, 0, true, false, true, false, true, true);
			idex.setCurrentInstruction("lw");
			//System.out.println("lw");
		}
		else if(opcode==-1409286144) { //sw
			idex.setRegIDEX(false, 0, true, false, false, true, false, true);
			idex.setCurrentInstruction("sw");
			//System.out.println("sw");
		}
		else if(opcode==268435456) { //branch
			idex.setRegIDEX(false, 1, false, true, false, false, false, true);
	...
	public void resetexhazardflag()
	{
		exhazardflag=false;
	}
	public void resetmemhazardflag()
	{
		memhazardflag=false;
	}
	public boolean isNull() {
		if(ifid.getCurrentInstruction().equals("null")) return true;
		else return false;
	}
}
